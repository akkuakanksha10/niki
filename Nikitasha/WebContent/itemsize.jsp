                    ...
                    <div class="margin-bottom-50">
                        ...
                        <form>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="Name" id="l0" name="itemsize">
                                </div>
                            </div>
                            
                                <div class="form-group row">
                                    <div class="col-md-9 col-md-offset-3">
                                        <input type="submit" class="btn width-150 btn-primary">Submit</button>
                                        <input type="submit" class="btn btn-default">Cancel</button>
                                    </div>
                                </div>
                        </form>
                        <!-- End Horizontal Form -->
